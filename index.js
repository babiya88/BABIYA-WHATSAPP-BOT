...
async function downloadSessionData() {
    ...
    try {
        ...
        console.log("🔒Babiya Session Successfully Loaded📱 !!");
        return true;
    } catch (error) {
...
async function start() {
    try {
        ...
        console.log(`👨‍💻 BABIYA-MD using WA v${version.join('.')}, isLatest: ${isLatest}`);
        
        const Matrix = makeWASocket({
            version,
            logger: pino({ level: 'silent' }),
            printQRInTerminal: useQR,
            browser: ["BABIYA-MD", "safari", "3.3"],
            auth: state,
        ...
        Matrix.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                if (initialConnection) {
                    console.log(chalk.green("📍 BABIYA-MD CONNECTED Successful️ ✅"));
